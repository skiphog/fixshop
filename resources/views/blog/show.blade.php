...
@section('content')
    <section id="blog-article-header" class="blog-article-header container mb-4">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="fix-section">
                    <h1>Блог - {{ $article->title }}</h1>
                </div>
            </div>
        </div>
    </section>
    <section id="blog-article" class="blog-article container mb-4">
        <div class="row">
            <div class="col-md-12">
                <article class="fix-section px-0 py-0">
